...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textBrowser_1 = QtWidgets.QTextBrowser(self.gridLayoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textBrowser_1.sizePolicy().hasHeightForWidth())
        self.textBrowser_1.setSizePolicy(sizePolicy)
        self.textBrowser_1.setMaximumSize(QtCore.QSize(16777215, 30))
        self.textBrowser_1.setObjectName("textBrowser_1")
        self.gridLayout_2.addWidget(self.textBrowser_1, 1, 1, 1, 1)
